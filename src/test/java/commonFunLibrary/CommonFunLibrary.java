...
public class CommonFunLibrary {
    ...
    public static void captureData(WebDriver driver,String locatortytpe,
		...
		FileWriter fw=new FileWriter("D:\\Batch80\\StockAccountingHybrid_BDD80\\CaptureData\\suppnumber.txt");
	...
	public static WebDriver startBrowser() throws Exception{
		System.setProperty("webdriver.chrome.driver","D:\\Batch80\\StockAccountingHybrid_BDD80\\drivers\\chromedriver.exe");
	    driver=new ChromeDriver();
		
		
//		if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
//			System.setProperty("webdriver.chrome.driver","D:\\Batch80\\StockAccountingHybrid\\drivers\\chromedriver.exe");
//		    driver=new ChromeDriver();
